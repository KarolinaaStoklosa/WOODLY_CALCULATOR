            ...
            {showAdvanced && (
                <div className="bg-white rounded-lg p-3 border border-gray-200">
                    ...
                    <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs">
                        <span className="text-gray-600">Powierzchnia:</span><span className="font-medium text-right">{formatSurface(bok.powierzchnia)} m²</span>
                        <span className="text-gray-600">Cena frontu za m²:</span><span className="font-medium text-right">{formatPrice(bok.cenaZaM2)} zł</span>
                        <span className="text-gray-600 border-t pt-1 mt-1">Wartość całkowita:</span><span className="font-bold text-green-600 text-right border-t pt-1 mt-1">{formatPrice(bok.cenaCałość)} zł</span>
                    </div>
                </div>
            )}
        </div>
